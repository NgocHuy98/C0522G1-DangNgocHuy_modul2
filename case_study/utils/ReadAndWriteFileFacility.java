...
public class ReadAndWriteFileFacility {
    ...
    public static Map<Facility, Integer> readFacilities(String path) {
        ...
        for (String line : strings) {
            info = line.split(",");
            if (info.length == 10) {
                facilityIntegerMap.put(new Villa(info[0],
                                info[1],
                ...
                facilityIntegerMap.put(new House(info[0],
                                info[1],
                                Double.parseDouble(info[2]),
                                Double.parseDouble(info[3]),
                                Integer.parseInt(info[4]),
                ...
                facilityIntegerMap.put(new Room(info[0],
                                info[1],
                                Double.parseDouble(info[2]),
                                Double.parseDouble(info[3]),
                                Integer.parseInt(info[4]),
